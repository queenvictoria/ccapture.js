...
function h(a){function c(){function a(){this._hooked||(this._hooked=!0,this._hookedTime=this.currentTime||0,this.pause(),O.push(this));return this._hookedTime+d.startTime}m("Capturer start");k=window.Date.now();n=k+d.startTime;w=window.performance.now();H=w+d.startTime;window.Date.prototype.getTime=function(){return n};window.Date._now=window.Date.now;window.Date.now=function(){return n};window.setTimeout=function(a,b){var l={callback:a,time:b,triggerTime:n+b};q.push(l);m("Timeout set to "+l.time);
return l};window.clearTimeout=function(a){for(var l=0;l<q.length;l++)q[l]==a&&(q.splice(l,1),m("Timeout cleared"))};window.setInterval=function(a,l){var b={callback:a,time:l,triggerTime:n+l};t.push(b);m("Interval set to "+b.time);return b};window.clearInterval=function(){m("clear Interval");return null};window.requestAnimationFrame=function(a){x.push(a)};window.performance.now=function(){return H};try{Object.defineProperty(HTMLVideoElement.prototype,"currentTime",{get:a}),Object.defineProperty(HTMLAudioElement.prototype,
"currentTime",{get:a})}catch(b){m(b)}}function e(){L=!1;i.stop();m("Capturer stop");window.setTimeout=B;window.setInterval=I;window.clearTimeout=M;window.requestAnimationFrame=S;window.Date.prototype.getTime=T;window.Date.now=U;window.performance.now=V}function g(){B(P,0,void 0)}function h(){var a=o/d.framerate;if(d.frameLimit&&o>=d.frameLimit||d.timeLimit&&a>=d.timeLimit)e(),r();var b=new Date(null);b.setSeconds(a);p.textContent=2<d.motionBlurFrames?"CCapture "+d.format+" | "+o+" frames ("+u+" inter) | "+
b.toISOString().substr(11,8):"CCapture "+d.format+" | "+o+" frames | "+b.toISOString().substr(11,8)}function P(){var a=(o+u/d.motionBlurFrames)*(1E3/d.framerate);n=k+a;H=w+a;O.forEach(function(b){b._hookedTime=a/1E3});h();m("Frame: "+o+" "+u);for(var b=0;b<q.length;b++)n>=q[b].triggerTime&&(B(q[b].callback,0,void 0),q.splice(b,1));for(b=0;b<t.length;b++)n>=t[b].triggerTime&&(B(t[b].callback,0,void 0),t[b].triggerTime+=t[b].time);x.forEach(function(a){B(a,0,n-W)});x=[]}function r(a){a||(a=function(a){download(a,
i.filename+i.extension,i.mimeType);return!1});i.save(a)}function m(a){s&&console.log(a)}function v(a){var b=D[a];b&&b.apply(null,Array.prototype.slice.call(arguments,1))}var d=a||{},s,n,k,H,w,i,q=[],t=[],o=0,u=0,x=[],L=!1,D={};d.framerate=d.framerate||60;d.motionBlurFrames=2*(d.motionBlurFrames||1);s=d.verbose||!1;d.step=1E3/d.framerate;d.timeLimit=d.timeLimit||0;d.frameLimit=d.frameLimit||0;d.startTime=d.startTime||0;var p=document.createElement("div");p.style.position="absolute";p.style.left=p.style.top=
0;p.style.backgroundColor="black";p.style.fontFamily="monospace";p.style.fontSize="11px";p.style.padding="5px";p.style.color="red";p.style.zIndex=1E5;d.display&&document.body.appendChild(p);var j=document.createElement("canvas"),C=j.getContext("2d"),f,A;m("Step is set to "+d.step+"ms");var a={gif:G,webm:y,ffmpegserver:z,websocketserver:E,png:J,jpg:K,"webm-mediarecorder":F},Q=a[d.format];if(!Q)throw"Error: Incorrect or missing format: Valid formats are "+Object.keys(a).join(", ");i=new Q(d);i.step=
g;i.on("process",P);i.on("progress",function(a){v("progress",a)});!1=="performance"in window&&(window.performance={});Date.now=Date.now||function(){return(new Date).getTime()};if(!1=="now"in window.performance){var R=Date.now();performance.timing&&performance.timing.navigationStart&&(R=performance.timing.navigationStart);window.performance.now=function(){return Date.now()-R}}var B=window.setTimeout,I=window.setInterval,M=window.clearTimeout,S=window.requestAnimationFrame,U=window.Date.now,V=window.performance.now,
T=window.Date.prototype.getTime,O=[];return{start:function(){c();i.start();L=!0},capture:function(a){if(L)if(2<d.motionBlurFrames){if(j.width!==a.width||j.height!==a.height)j.width=a.width,j.height=a.height,f=new Uint16Array(4*j.height*j.width),C.fillStyle="#0",C.fillRect(0,0,j.width,j.height);C.drawImage(a,0,0);A=C.getImageData(0,0,j.width,j.height);for(a=0;a<f.length;a+=4)f[a]+=A.data[a],f[a+1]+=A.data[a+1],f[a+2]+=A.data[a+2];u++;if(u>=0.5*d.motionBlurFrames){for(var a=A.data,b=0;b<f.length;b+=
4)a[b]=2*f[b]/d.motionBlurFrames,a[b+1]=2*f[b+1]/d.motionBlurFrames,a[b+2]=2*f[b+2]/d.motionBlurFrames;C.putImageData(A,0,0);i.add(j);o++;u=0;m("Full MB Frame! "+o+" "+n);for(b=0;b<f.length;b+=4)f[b]=0,f[b+1]=0,f[b+2]=0;gc()}else g()}else i.add(a),o++,m("Full Frame! "+o)},stop:e,save:r,on:function(a,b){D[a]=b},getTiming:function(){return{framecount:o,intermediateframecount:u,time:n,performancetime:H}}}}var g={"function":!0,object:!0},r=g[typeof exports]&&exports&&!exports.nodeType?exports:void 0,
